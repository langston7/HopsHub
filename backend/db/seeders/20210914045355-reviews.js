...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Reviews', [
      {comment:"Placeholder comment", userId:1, drinkId:1},
      {comment:"Placeholder comment", userId:2, drinkId:1},
      {comment:"Placeholder comment", userId:1, drinkId:2},
      {comment:"Placeholder comment", userId:2, drinkId:2},
      {comment:"Placeholder comment", userId:1, drinkId:3},
      {comment:"Placeholder comment", userId:3, drinkId:3},
      {comment:"Placeholder comment", userId:1, drinkId:4},
